...
/**
 * 查询订单 {@link https://api.mch.weixin.qq.com/pay/orderquery}
 * 
 * @author Jack
 */
public class OrderQueryRequestBuilder extends RequestBuilder {
	...
	/** [二选一]微信订单号 String(32) 微信的订单号，建议优先使用 */
	private String transaction_id = "";
	/** [二选一]商户订单号 String(32) 商户系统内部的订单号，请确保在同一商户号下唯一。 */
	...
	public String buildDigest() {
		...
		param.put("transaction_id", transaction_id);// 微信订单号，二选一，微信的订单号，建议优先使用 。
		param.put("out_trade_no", out_trade_no);// 商户订单号，二选一，商户系统内部订单号，要求32个字符内、且在同一个商户号下唯一。
